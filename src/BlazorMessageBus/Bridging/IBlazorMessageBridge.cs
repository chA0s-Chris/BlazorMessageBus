...
public interface IBlazorMessageBridge : IDisposable
{
    ...
    /// <summary>
    /// Starts the message bridge with the specified outbound message handler.
    /// </summary>
    /// <param name="outboundHandler">The handler that will be called for each outbound message that should be bridged.</param>
    /// <param name="cancellationToken">Cancellation token for the operation.</param>
    /// <returns>A task representing the asynchronous start operation.</returns>
    Task StartAsync(BridgeMessageHandler outboundHandler, CancellationToken cancellationToken = default);

    /// <summary>
    /// Stops the message bridge and ceases forwarding messages.
    /// </summary>
    /// <param name="cancellationToken">Cancellation token for the operation.</param>
